...
import com.swein.camera.advance.area.CompareSizesByArea;
...
import static com.swein.camera.advance.data.AdvanceCameraContent.MAX_PREVIEW_HEIGHT;
import static com.swein.camera.advance.data.AdvanceCameraContent.MAX_PREVIEW_WIDTH;
import static com.swein.camera.advance.data.AdvanceCameraContent.STATE_PICTURE_TAKEN;
import static com.swein.camera.advance.data.AdvanceCameraContent.STATE_PREVIEW;
import static com.swein.camera.advance.data.AdvanceCameraContent.STATE_WAITING_LOCK;
import static com.swein.camera.advance.data.AdvanceCameraContent.STATE_WAITING_NON_PRECAPTURE;
import static com.swein.camera.advance.data.AdvanceCameraContent.STATE_WAITING_PRECAPTURE;
import static com.swein.camera.advance.permission.AdvanceCameraPermission.REQUEST_CAMERA_PERMISSION;
...
public class CameraFragment extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback, View.OnClickListener{
    ...
    public void checkDeviceCompatibleOfCamera() {
        try {
            ...
            ILog.iLogDebug(TAG, "FULL" + (level == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_FULL));
            ILog.iLogDebug(TAG, "LEGACY" + (level == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY));
            ILog.iLogDebug(TAG, "LIMITED" + (level == CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_LIMITED));

        } catch (CameraAccessException e) {
            ILog.iLogDebug(TAG, "Device not compatible of camera2 api " + e);
        }
    }
     ...
     *
     * @param choices           The list of sizes that the camera supports for the intended class
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        for (Size option : choices) {
            if (option.getWidth() <= maxWidth && option.getHeight() <= maxHeight &&
                    option.getHeight() == option.getWidth() * aspectRatio.getHeight() / aspectRatio.getWidth()) {
        ...
        if (bigEnough.size() > 0) {
            ...
            ILog.iLogError(TAG, "Couldn't find any suitable preview size");
            return choices[0];
        }
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        autoFitTextureView = (AutoFitTextureView) view.findViewById(R.id.autoFitTextureView);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            ...
            requestPermissionsResult(getActivity(), requestCode, permissions, grantResults);
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                switch (displayRotation) {
                    ...
                    case Surface.ROTATION_270:
                        ...
                        break;
                    default:
                        ILog.iLogError(TAG, "Display rotation is invalid: " + displayRotation);
                }
