...
public class SHMDMReceiver extends DeviceAdminReceiver {
    ...
    public void onEnabled(Context context, Intent intent) {
        ...
        ESSCenter.getInstance().sendEventMessage(ESSArrows.ESS_DEVICE_MANAGER_USABLE, this, null);
    }

    @Override
    public void onDisabled(Context context, Intent intent) {
        ToastUtil.showShortToastNormal(context, "핸드폰 기능 제한 해제되었습니다");
        ESSCenter.getInstance().sendEventMessage(ESSArrows.ESS_DEVICE_MANAGER_DISABLE, this, null);
    }
